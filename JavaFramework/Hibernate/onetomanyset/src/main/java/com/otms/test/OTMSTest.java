...
public class OTMSTest {
    public static void main(String[] args) {
        ...
        try {
            ...
            Manufacturer manufacturer = Manufacturer.of()
                    ...
                    .establishDate(LocalDate.now().minusYears(7))
                    .headquarters("Surat")
                    .contactNo("8843256785")
                    .emailAddress("ckinfo@gmail.com")
                    .products(products).build();
            int manufacturerNo = saveManufacturer(manufacturer);
            System.out.println("manufacturerNo: "+ manufacturerNo);*/

            /*Product product = findProduct(3);
    ...
    private static Product findProduct(int productNo){
